...
with st.sidebar:
    ...
    st.markdown('<p style="font-size:20px;"><span style="color:#FF0000 !important;">●</span> 需求紅區 (佔用 >= 90%)</p>', unsafe_allow_html=True)
    st.markdown('<p style="font-size:20px;"><span style="color:#FFAA00 !important;">●</span> 高潛力區 (佔用 75-89%)</p>', unsafe_allow_html=True)
    st.markdown('<p style="font-size:20px;"><span style="color:#28A745 !important;">●</span> 正常區域 (佔用 < 75%)</p>', unsafe_allow_html=True)
